...
namespace TM
{
    ...
    {
        m_vPosition = osg::Vec3(-22.0, -100.0, 20.0);
    ...
    osg::Matrixd TravelManipulator::getMatrix() const
    {
        osg::Matrix matrix;
        matrix.identity();
        matrix.makeRotate(m_vRotation._v[0], osg::X_AXIS,
            m_vRotation._v[1], osg::Y_AXIS,
            m_vRotation._v[2], osg::Z_AXIS);
        ...
        case osgGA::GUIEventAdapter::KEYDOWN:
            {
                ...
                {
                    // 左移
                    ChangePosition(osg::Vec3 ( m_dSpeed, 0, 0));
                    return false;
                }
        ...
        case osgGA::GUIEventAdapter::DRAG:
            {
                ...
                if (m_bMousePress)
                {
                    ...
                    qDebug() << m_vRotation._v[2] << "--" << m_vRotation._v[0] << endl;
